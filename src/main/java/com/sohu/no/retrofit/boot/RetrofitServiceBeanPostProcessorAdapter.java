package com.sohu.no.retrofit.boot;

import com.sohu.no.retrofit.autoconfigure.RetrofitProperties;
import com.sohu.no.retrofit.boot.annotation.RetrofitService;
